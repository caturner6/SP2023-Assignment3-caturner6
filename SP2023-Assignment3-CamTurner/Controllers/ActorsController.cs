...
namespace SP2023_Assignment3_CamTurner.Controllers
{
    public class ActorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Gender,Age,IMDBUrl,MovieId")] Actors actors, IFormFile ActorPhoto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Gender,Age,IMDBUrl,MovieId")] Actors actors, IFormFile ActorPhoto)
        {
            if (id != actors.Id)
            {
                return NotFound();
