...
using SP2023_Assignment3_CamTurner.Data;
using SP2023_Assignment3_CamTurner.Models;
using Tweetinvi;
using VaderSharp2;

namespace SP2023_Assignment3_CamTurner.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,IMDBUrl,Genre,ReleaseYear")] Movies movies, IFormFile MoviePoster)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,IMDBUrl,Genre,ReleaseYear")] Movies movies, IFormFile MoviePoster)
        {
            if (id != movies.Id)
            {
                return NotFound();
